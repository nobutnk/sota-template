 ...
 *
 */
public abstract class AbstractSotaService implements SotaService {
    
    protected final CRobotMem mem;
    //Sota用モーション制御クラス
    protected final CSotaMotion motion;
    protected final SpeechRecog recog;
     ...
     */
    public AbstractSotaService(CRobotMem mem, CSotaMotion motion, SpeechRecog recog) {
        this.mem = mem;
        this.motion = motion;
        this.recog = recog;
    }
